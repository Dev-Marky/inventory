...
<!-- Mirrored from uxpowered.com/products/pixeladmin/v232/html_demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Mar 2018 10:09:31 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <link href="vendorscode.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css">
  <link href="vendorsmaxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">

  <!-- DEMO ONLY: Function for the proper stylesheet loading according to the demo settings -->
  <script>function _pxDemo_loadStylesheet(a,b,c){var c=c||decodeURIComponent((new RegExp(";\\s*"+encodeURIComponent("px-demo-theme")+"\\s*=\\s*([^;]+)\\s*;","g").exec(";"+document.cookie+";")||[])[1]||"clean"),d="rtl"===document.getElementsByTagName("html")[0].getAttribute("dir");document.write(a.replace(/^(.*?)((?:\.min)?\.css)$/,'<link href="$1'+(c.indexOf("dark")!==-1&&a.indexOf("https://uxpowered.com/css/")!==-1&&a.indexOf("https://uxpowered.com/themes/")===-1?"-dark":"")+(!d||0!==a.indexOf("assets/css")&&0!==a.indexOf("assets/demo")?"":".rtl")+'$2" rel="stylesheet" type="text/css"'+(b?'class="'+b+'"':"")+">"))}</script>
  ...
  <script>
    ...
    _pxDemo_loadTheme('assets/css/themes/index.html');
  </script>
  ...
  <!-- holder.js -->
  <script type="text/javascript" src="vendorscdnjs.cloudflare.com/ajax/libs/holder/2.9.0/holder.js"></script>
...
<body>
    ...
    <ul class="px-nav-content">
      ...
      <li class="px-nav-item px-nav-dropdown">
        ...
        <ul class="px-nav-dropdown-menu">
          <li class="px-nav-item"><a href="index-2.html"><span class="px-nav-label">Default</span></a></li>
      ...
      <li class="px-nav-item">
        <a href="https://uxpowered.com/products/pixeladmin/v232/color_generator/index.html"><i class="px-nav-icon ion-aperture"></i><span class="px-nav-label">Color Generator</span></a>
      </li>
      <li class="px-nav-item">
        <a href="https://uxpowered.com/products/pixeladmin/v232/docs/index.html" target="_blank" class="bg-success text-white b-a-0"><i class="px-nav-icon ion-social-buffer"></i><span class="px-nav-label">Docs</span></a>
      </li>
  ...
  <nav class="navbar px-navbar">
    ...
    <div class="navbar-header">
      <a class="navbar-brand px-demo-brand" href="index-2.html"><span class="px-demo-logo bg-primary"><span class="px-demo-logo-1"></span><span class="px-demo-logo-2"></span><span class="px-demo-logo-3"></span><span class="px-demo-logo-4"></span><span class="px-demo-logo-5"></span><span class="px-demo-logo-6"></span><span class="px-demo-logo-7"></span><span class="px-demo-logo-8"></span><span class="px-demo-logo-9"></span></span>PixelAdmin</a>
    </div>
          ...
          <div class="tab-content p-a-0">
            ...
            <div id="threads" class="ps-block tab-pane fade" style="height: 300px">
              <div class="widget-threads-item">
                <img src="assets/demo/avatars/2.jpg" alt="" class="widget-threads-avatar">
              ...
              <div class="widget-threads-item">
                <img src="assets/demo/avatars/3.jpg" alt="" class="widget-threads-avatar">
                <span class="widget-threads-date">14h</span>
                <a href="#" class="widget-threads-title">Lorem ipsum dolor sit amet</a>
              ...
              <div class="widget-threads-item">
                <img src="assets/demo/avatars/4.jpg" alt="" class="widget-threads-avatar">
                <span class="widget-threads-date">14h</span>
                <a href="#" class="widget-threads-title">Lorem ipsum dolor sit amet</a>
              ...
              <div class="widget-threads-item">
                <img src="assets/demo/avatars/5.jpg" alt="" class="widget-threads-avatar">
                <span class="widget-threads-date">14h</span>
                <a href="#" class="widget-threads-title">Lorem ipsum dolor sit amet</a>
  ...
  <!-- jQuery -->
  <script src="vendorsajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    $(function() {
      var file = String(document.location).split('https://uxpowered.com/').pop();
...
<!-- Mirrored from uxpowered.com/products/pixeladmin/v232/html_demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Mar 2018 10:10:08 GMT -->
</html>

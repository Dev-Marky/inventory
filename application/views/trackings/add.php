          ...
          <?php echo form_open('trackings/add', array('method' => 'post', 'class' => 'form-horizontal')); ?>
            <div class="panel-body">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <?php echo form_input('date_ordered', '', 'placeholder="Date Ordered" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <?php echo form_input('item_image', '', 'placeholder="Image" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
                <label for="demo-is-inputnormal" class="col-sm-3 control-label">Date Shipped</label>
                <div class="col-sm-6">
                  <?php echo form_input('date_shipped', '', 'placeholder="Date Shipped" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
                <label for="demo-is-inputnormal" class="col-sm-3 control-label">Item</label>
                <div class="col-sm-6">
                  <?php echo form_input('item', '', 'placeholder="Item" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
                <label for="demo-is-inputnormal" class="col-sm-3 control-label">Notes</label>
                <div class="col-sm-6">
                  <?php echo form_textarea('address', '', 'placeholder="Notes" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
                <label for="demo-is-inputnormal" class="col-sm-3 control-label">Tracking Number</label>
                <div class="col-sm-6">
                  <?php echo form_input('tracking_number', '', 'placeholder="Tracking Number" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
                <label for="demo-is-inputnormal" class="col-sm-3 control-label">Date Delivered</label>
                <div class="col-sm-6">
                  <?php echo form_input('date_delivered', '', 'placeholder="Date Delivered" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
            </div>
